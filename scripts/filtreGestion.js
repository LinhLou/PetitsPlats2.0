class FiltreGestion {
  constructor(domNode){
    ...
    this.inputSearch = [...this.filtreCategory].reduce((acc,ele)=>{acc = [...acc,ele.querySelector('input')];
    return acc},[]);

    this.xCloseSearch = [...this.filtreCategory].reduce((acc,ele)=>{acc = [...acc,ele.querySelector('.searchBar_xClose')];
    return acc},[]);
